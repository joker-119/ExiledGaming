...
using Config = JokersPlayground.Configs.Config;
...
namespace JokersPlayground
{
    ...
    using JokersPlayground.BanSystem;
    using JokersPlayground.Components;
    using JokersPlayground.Configs;
    using JokersPlayground.EventHandlers;
    using UnityEngine;
    ...
    public class Plugin : Plugin<Config>
    {
        ...
        public override string Name => "JokersPlayground";
        public override string Prefix => "JokersPlayground";
